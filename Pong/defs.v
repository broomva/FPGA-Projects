...
`define BALL_HSIZE  11'd10
`define BALL_VSIZE  11'd10
`define BALL_RED    3'h7;
`define BALL_GREEN  3'h2;
`define BALL_BLUE   2'h4;
...
`define TABLE_WIDTH   11'd6

`define PADDLE_HEIGHT 11'd60
`define PADDLE_WIDTH  11'd10
